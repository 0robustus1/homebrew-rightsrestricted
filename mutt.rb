...
class Mutt < Formula
  ...
  # patch currently (2014-06-08) offline, as lunar-linux is going
  # through server-migrations
  patch do
    # url "http://lunar-linux.org/~tchan/mutt/patch-1.5.23.sidebar.20140412.txt"
    url "https://gist.githubusercontent.com/0robustus1/f618b4db64893d1d0b17/raw/76c2578ec814ddd973cdcc241c363423c33869bf/sidebar-patch"
    sha1 "5586acf2a137c2857a805d72dbf4ca06f053c764"
